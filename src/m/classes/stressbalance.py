...
class stressbalance(object):
    ...
    def __repr__(self):  # {{{
        ...
        s += '{}\n'.format(fielddisplay(self, 'anderson_depth', 'Anderson acceleration window m (0: pure Picard, recommended: 5)'))
    ...
    def checkconsistency(self, md, solution, analyses):  # {{{
        ...
        md = checkfield(md, 'fieldname', 'stressbalance.anderson_depth', 'size', [1], '>=', 0)
